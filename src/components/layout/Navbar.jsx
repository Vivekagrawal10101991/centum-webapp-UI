            ...
            <div className="hidden lg:flex items-center space-x-3">
              {isAuthenticated ? (
                <div className="flex items-center space-x-3">
                  <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl backdrop-blur-sm">
            ...
            <div className="lg:hidden pt-4 mt-4 border-t border-gray-100">
              <div className="flex flex-col space-y-2">
                ...
                <div className="pt-4 border-t border-gray-100 space-y-2">
                  {isAuthenticated ? (
                    <>
                      <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl">
